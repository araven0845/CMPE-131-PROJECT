...
export default function CreateRoutineScreen() {
  ...
  const saveRoutine = async () => {
    ...
    // Note: Don't need to include id here since Firebase will generate one
    const routineData = {
      name: routineName,
      exercises: exercises,
      // createdAt will be added by addRoutine
    };
  
    // Wait for the Firebase ID to be returned
    const firestoreId = await addRoutine(routineData);
    router.back();
  };
